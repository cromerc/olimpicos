...
En el caso de \nameref{sec:modelo}, tenemos el \nameref{sec:mer} y \nameref{sec:mr} que fueron usados para construir nuestro base de datos.
...
\label{sec:mer}
\begin{center}
    \includegraphics[angle=270,origin=c,width=0.80\textwidth,height=0.80\textheight,keepaspectratio]{../modelo/MER.png}
\end{center}
